...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    { name: 'Twitter', icon: 'M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2s9 5 20 5a9.5 9.5 0 00-9-5.5c4.75 2.25 7-7 7-7' },
  ]

  return (
    <footer className="relative bg-gradient-to-b from-slate-900 to-black py-16 px-4 sm:px-6 lg:px-8 border-t border-slate-800/50 overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12 pb-12 border-b border-slate-800/50">
          {/* Brand Section */}
          <div>
            <h3 className="text-xl font-bold text-white mb-2">Yash Goswami</h3>
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-sm font-semibold text-gray-300 mb-4 uppercase tracking-wider">Get In Touch</h4>

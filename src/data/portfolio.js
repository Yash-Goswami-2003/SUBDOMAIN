...
export const testData = {
  ...
  bio: "Experienced developer specializing in building scalable web applications and AI-powered tools.",
  tagline: "Bridging the gap between hardware and software through innovation",
  experience: 3,
  experienceUnit: "Years",
  location: "India",
  email: "yashgoswamiyg2003@gmail.com",
  ...
  skills: [
    ...
    { name: "MERN Stack", category: "Full Stack", proficiency: 90 },
    { name: "Arduino Mega", category: "Hardware", proficiency: 80 },
    { name: "JavaScript", category: "Language", proficiency: 95 },
    { name: "GenAI", category: "AI", proficiency: 55 }
  ],
  ...
  // About Me
  about: {
    story: "I am a graduate in Electronics and Communication Engineering from Birla Institute of Applied Sciences (2025). My passion lies in software development and bridging hardware with modern web technologies. From optimizing core system modules to building AI-driven presentation tools, I focus on efficiency, stability, and user experience.",
    interests: ["Artificial Intelligence", "Hardware Interfacing", "Digital Circuits", "Collaborative Learning"],
    values: ["Excellence", "Stability", "Innovation", "Efficiency"]
  }
};
